...
google.maps.event.addListener(layer, 'click', function(e) {
    ...
    e.infoWindowHtml = ' <div class="googft-info-window" align="left"> <b>Ratio of Transit Dependent Population:</b>' + e.row["Ratio of Transit Dependent Population"].value + ' <br> <form action="vote.php" method="post" target="_blank"> Have a different opinion? </br> <input onclick="initVote(true);" type="radio" name="opinion" value="1" id="yes"> <label for="yes">This is a transit desert!</label> </br> <input onclick="initVote(false);" type="radio" name="opinion" value="0" id="no"> <label for="no">This is <b>not</b> a transit desert!</label> </br> <div id="isDesert" style="display:none"> Why do you think this blockgroup is a transit desert?</br> <input type="checkbox" name="why[]" value="1" id="yes1"> <label for="yes1">Not having enough transit lines and stops.</label> </br> <input type="checkbox" name="why[]" value="2" id="yes2"> <label for="yes2">Having enough transit lines and stops but too many people need to take transit.</label> </br> <input type="checkbox" name="why[]" value="3" id="yes3"> <label for="yes3">Transit service is not frequent e.g. have to wait long time for bus, no service on weekends.</label> </br> <input type="checkbox" name="why[]" value="4" id="yes4"> <label for="yes4">Too many transfers to important locations within the cities. </label> </br> <textarea cols="50" rows="3" name="reasonYes" placeholder="Other reasons (less than 280 characters):"></textarea> </div> <div id="notDesert" style="display:none"> Why do you think this blockgroup is <b>not</b> a transit desert?</br> <input type="checkbox" name="why[]" value="1" id="no1"> <label for="no1">Enough transit lines, stops and have frequent services.</label> </br> <input type="checkbox" name="why[]" value="2" id = "no2"> <label for="no2">Most people have a car and nobody ride or want to ride transit.</label> </br> <input type="checkbox" name="why[]" value="3" id="no3"> <label for="no3">Without transit I can conveniently get where I want to by other methods (e.g. Uber, Lyft, Walk, Bike).</label> </br> <textarea cols="50" rows="3" name="reasonNo" placeholder="Other reasons (less than 280 characters):"></textarea> </div> <input type="hidden" name="geoid" value="' + geoid + '"/>	<input type="submit" value="submit"> </form> </div> </div> ';
});
}
